...
, renamed as (
    select
        ...
        -- , min__v_double as pace_min -- Column not present in source
        -- , max__v_double as pace_max -- Column not present in source
        , cast(null as double) as pace_min
        , cast(null as double) as pace_max
        , time
